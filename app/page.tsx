          ...
          <div className="lg:sticky lg:top-6 h-fit space-y-8">
            ...
            <div className="flex items-center justify-between gap-8">
              <div className="flex items-center gap-4 group">
                <Image
                  src="https://i.ibb.co/ZzK6jQGW/1705436353196.jpg"
                  alt="Anas Hamad"
                  width={60}
                  height={60}
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                {[
                  ...
                  {
                    icon: <Image src="https://i.ibb.co/rRvbdL5p/image.png" alt="Kaggle" width={20} height={20} />,
                    label: "Kaggle",
                ...
                <div className="border border-neutral-200 dark:border-neutral-700 rounded-lg p-4 transition-all duration-300 hover:border-neutral-300 hover:shadow-sm dark:hover:border-neutral-600 dark:hover:shadow-sm">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {[
                      {
                        name: "Python",
                        logo: "https://cdn-icons-png.flaticon.com/512/5968/5968396.png",
                ...
                {[
                  {
                    ...
                    image: "https://i.ibb.co/TxtNTHkJ/image.png",
                  ...
                  },
                  {
                    ...
                    image: "https://i.ibb.co/dsTVdqw2/image.png",
